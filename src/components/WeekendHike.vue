<template>
  <v-card>
    <v-toolbar flat color="primary" dark>
      <v-toolbar-title>Походы выходного дня</v-toolbar-title>
    </v-toolbar>
    <v-tabs vertical>
      <v-tab>
        <v-icon left>
      ...
      <v-tab-item>
        <v-card flat>
          <v-card-text>
            <div v-for="value in skiTracks" :key="value.key">
              <LinkButton
                :label="value.title"
                :link="value.link"
      ...
      <v-tab-item>
        <v-card flat>
          <v-card-text>
            <div v-for="value in kayakTracks" :key="value.key">
              <LinkButton
                :label="value.title"
                :link="value.link"
                :icon="'mdi-map-marker-multiple'"
      ...
      skiTracks: [
        {
          title: 'Лыжи 2024',
          key: 'ski2024',
          link: 'https://nakarte.me/#m=10/55.88340/37.24887&l=O&nktl=Sz0uptf4NHdl4DBQvI28KQ',
        },
        {
          title: 'Лыжи 2023',
          key: 'ski2023',
        ...
        },
        {
          title: 'Лыжи 2022',
          key: 'ski2022',
          link: 'https://nakarte.me/#m=10/55.83716/38.20221&l=O&nktl=q-moXVXl2vvYp0i4P9MKGQ',
        },
        {
          title: 'Лыжи 2021',
          key: 'ski2021',
          link: 'https://nakarte.me/#m=9/55.70622/37.89734&l=O&nktl=O1XNrzzifW9lYXGnYAg-Zg',
        },
        {
          title: 'Лыжи 2019',
          key: 'ski2019',
